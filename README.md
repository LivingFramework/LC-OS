...
| Content | Description |
|---------|-------------|
| [Papers](https://github.com/LivingFramework/LC-OS/blob/main/Papers) | Eight research papers covering governance, framework, failure/repair, linguistic governance, architecture, cognition, and validation |
| [Mahdi Ledger](https://github.com/LivingFramework/LC-OS/blob/main/Mahdi_Ledger) | A published collaboration ledger — the raw trace of LC-OS in action, written by the AI |
...
→ [Read Paper 1](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/17760288
...
→ [Read Paper 2](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/17760777
...
→ [Read Paper 3](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/17896542
...
→ [Read Paper 4](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/18015990
...
→ [Read Paper 5](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/18900058
...
→ [Read Paper 6](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/19038340
...
→ [Read Paper 7](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/19151397
...
→ [Read Paper 8](https://github.com/LivingFramework/LC-OS/blob/main/Papers) · **Zenodo:** https://zenodo.org/records/19983551
...
→ [Read the Mahdi Ledger](https://github.com/LivingFramework/LC-OS/blob/main/Mahdi_Ledger) · **Zenodo:** https://zenodo.org/records/18054346
...
7. **The Core Question** — *"How do we build a frame in which both human and system can keep working together, under load, without losing themselves?"*
...
Start with Paper 1. It establishes why governance matters and is the most grounded — written closest to the empirical work.
...
**If you want the complete theoretical picture:**
Papers 6 and 7 together give you the most formal account of what the research ultimately arrived at.

**If you're building AI systems:**
Paper 8 is most directly relevant — validation as a first-class architectural component.

**If you want the human side:**
Paper 4 and the Mahdi Ledger — Paper 4 from the human's perspective, the Ledger from the AI's.
...
**Suggested reading order for the full program:**
...
Individual paper citations are available in [Papers/README.md](https://github.com/LivingFramework/LC-OS/blob/main/Papers/README.md).
...
This work is licensed under [CC BY 4.0](https://github.com/LivingFramework/LC-OS/blob/main/LICENSE.md).
...
Contact: [rishisood@protonmail.com](mailto:rishisood@protonmail.com)
